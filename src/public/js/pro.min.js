      ...
      return (
         ...
         s
            ? ((b = (v = t).prefix),
              ...
              (y = v.attributes),
              (v =
                 !0 === (v = v.symbol) ? ''.concat(b, '-').concat(Z.cssPrefix, '-').concat(g) : v),
              [
                 {
                    tag: 'svg',
                    attributes: { style: 'display: none;' },
                    children: [
                       { tag: 'symbol', attributes: k(k({}, y), {}, { id: v }), children: h },
                    ],
                 },
              ])
            : ((g = (b = t).children),
         ...
         delete e[0].attributes.id,
            e[0].attributes.class &&
               ((t = e[0].attributes.class.split(' ').reduce(
                  function (t, a) {
                     return (
                        (a === Z.replacementClass || a.match(n) ? t.toSvg : t.toNode).push(a), t
                     );
                  },
                  { toNode: [], toSvg: [] },
               )),
               ...
               counter: function (i) {
                  ...
                  return fa({ type: 'counter', content: i }, function () {
                     return (
                        ...
                        e &&
                           n.push({ tag: 'span', attributes: { class: 'sr-only' }, children: [e] }),
                        n
                     );
                     var t, a, e, n;
                  });
               ...
               t.generateAbstractMask = function (t) {
                  var a = t.children,
                     ...
                     f = {
                        ...
                        children: [
                           Ja(k({ tag: c.tag, attributes: k(k({}, c.attributes), o.path) }, f)),
                        ],
                     },
                        ...
                        t.push({
                           ...
                           children: r
                              ...
                              : [
                                   {
                                      tag: 'animate',
                                      attributes: k(k({}, n), {}, { values: '1;0;0;0;0;1;' }),
                                   },
                                ],
                        }),
                        r ||
